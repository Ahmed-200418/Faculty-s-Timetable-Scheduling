...
def genetic_algorithm(population, generations=100, mutation_rate=0.1):
    ...
    for generation in range(generations):
        ...
        for _ in range(len(population) // 2):  # Produce pairs of children
            parent1 = tournament_selection(population, pop_scores,len(population) // 10) # type: ignore
            parent2 = tournament_selection(population, pop_scores, len(population) // 10) # type: ignore
